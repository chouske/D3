...
class stage1 extends Phaser.Scene {
    ...
    create(){
        ...
        this.player = this.physics.add.sprite(500, 600, 'monkey').setScale(0.3)
...
class stage2 extends Phaser.Scene {
    ...
    preload(){
        this.load.path = './assets/';
        this.load.image('floor', 'Floor.png')
        this.load.image('hill1', 'Hillpt1.png')
        this.load.image('hill2', 'Hillpt2.png')
        this.load.image('hill3', 'Hillpt3.png')
        this.load.image('hill4', 'Hillpt4.png')
        this.load.image('house', 'House.png')
        this.load.image('tree', 'Tree.png')
        this.load.image('apple', 'Apple.png')
        this.load.image('monkey', 'Monkey.png')
    ...
    create(){
        ...
        this.player = this.physics.add.sprite(500, 960, 'monkey').setScale(0.3)
        this.player.airjump = false;
        this.player.setCollideWorldBounds(true);
        //this.player.setCollideWorldBounds(true);
        //this.physics.add.image(1300, 200, 'apple').setScale(0.5).setBounce(0.2)
...
class stage3 extends Phaser.Scene {
    ...
    create(){
        ...
        this.platforms.create(400, 300, 'planet1').setSize(104, 99)
        this.apples.create(425, 205, 'apple').setScale(0.5)
        ...
        this.player = this.physics.add.sprite(500, 850, 'monkey').setScale(0.3)
        this.player.airjump = false;
        this.player.setCollideWorldBounds(true);
        this.cursors = this.input.keyboard.createCursorKeys();
        this.physics.add.collider(this.player, this.platforms)
...
const config = {
    ...
    //scene: stage1,
    scene: [stage2, stage1, middle, stage3, middle2, intro, end],
    physics: {
        default: 'arcade',
        arcade: {
            gravity: { y: 600 },
